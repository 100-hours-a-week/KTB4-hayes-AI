...
## 회고
FastAPI를 사용해본 적은 있지만 대부분 AI에게 의존해서 사용했었는데 이번 프로젝트를 진행하면서
최대한 공식 문서와 기술 블로그 글을 찾아보며 직접 구현하였다.

전체적인 서버 구조에 대한 이해도가 많이 올라갔고 또한 api llm 말고 로컬 llm은 처음 써봤는데 좋은 경험이였다.

추후 있을 프로젝트에서도 더 효율적인 프로젝트 구조로 진행할 수 있을 것 같다.